...
print("Step 4 - Completed model penalized DLNM with variable selection Backward prunning (output: RES1.DLNMselect.i.exp3.backward.AVGEXWAS...)")
...
print("Step 5 - Completed model penalized DLNM with variable selection Backward prunning with additional columns (output: RES1.DLNMselect.i.exp3.backward..AVGEXWAS.v2...)")
...
RES1.DLNMselect.i.exp3 <- foreach(i = 1:nsim,.packages=c("foreach","Matrix","MASS","parallel","glmnet","spls","MXM","dlnm","splines","mgcv","doParallel",
                                                         "ranger","palmerpenguins","tidyverse","kableExtra")) %dopar% {
                                                           ...
                                                           data.frame(applyDLNMforwardsel(data.Y=resu.sim.data1.exp3[[i]],data.X=resu.sim.dataX.i[[i]]$X,padj="none",i),i)[,-10]
                                                           
                                                         }

save(RES1.DLNMselect.i.exp3,file=paste0("dataY1andX/exp3/RES1.DLNMselect.i.exp3.Forward.",as.character(padj),".RData"))

print("Step 6 - Completed model penalized DLNM with variable selection Forward prunning (output: RES1.DLNMselect.i.exp3.Forward...)")
...
RES1.DLNMselect.i.exp3.v2_Forward<-RES1.DLNMselect.i.exp3

save(RES1.DLNMselect.i.exp3.v2_Forward,file=paste0("dataY1andX/exp3/RES1.DLNMselect.i.exp3.Forward.v2.",as.character(padj),".RData"))

#*#
load(paste0("dataY1andX/exp3/RES1.DLNMselect.i.exp3.Forward.v2.",as.character(padj),".RData"))

for(i in 1:nsim) {
  RES1.DLNMselect.i.exp3.v2_Forward[[i]]$DLNMpen.TP_dic <- ifelse(RES1.DLNMselect.i.exp3.v2_Forward[[i]]$p.value<0.05,1,0)
  #RES1.DLNMselect.i.exp3.v2_Forward[[i]]$DLNMpen.TP_dic[is.na(RES1.DLNMselect.i.exp3.v2_Forward[[i]]$p.value)] <- 0
}

save(RES1.DLNMselect.i.exp3.v2_Forward,file=paste0("dataY1andX/exp3/RES1.DLNMselect.i.exp3.Forward.v2.",as.character(padj),".RData"))
#*#

print("Step 7 - Completed model penalized DLNM with variable selection Forward prunning with additional columns (output: RES1.DLNMselect.i.exp3.Forward.v2...)")
