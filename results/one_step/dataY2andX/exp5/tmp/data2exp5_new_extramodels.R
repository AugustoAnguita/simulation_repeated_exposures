...
print("Step 4 - Completed model penalized DLNM with variable selection Backward prunning (output: RES2.DLNMselect.i.exp5.backward.AVGEXWAS...)")
...
print("Step 5 - Completed model penalized DLNM with variable selection Backward prunning with additional columns (output: RES2.DLNMselect.i.exp5.backward.AVGEXWAS.v2...)")
...
RES2.DLNMselect.i.exp5 <- foreach(i = 1:nsim,.packages=c("foreach","Matrix","MASS","parallel","glmnet","spls","MXM","dlnm","splines","mgcv","doParallel",
                                                         "ranger","palmerpenguins","tidyverse","kableExtra")) %dopar% {
                                                           ...
                                                           data.frame(applyDLNMforwardsel(data.Y=resu.sim.data2.exp5[[i]],data.X=resu.sim.dataX.i[[i]]$X,padj="none",i),i)[,-10]
                                                           
                                                         }

save(RES2.DLNMselect.i.exp5,file=paste0("dataY2andX/exp5/RES2.DLNMselect.i.exp5.Forward.",as.character(padj),".RData"))

print("Step 6 - Completed model penalized DLNM with variable selection Forward prunning (output: RES2.DLNMselect.i.exp5.Forward...)")
...
RES2.DLNMselect.i.exp5.v2_Forward<-RES2.DLNMselect.i.exp5

save(RES2.DLNMselect.i.exp5.v2_Forward,file=paste0("dataY2andX/exp5/RES2.DLNMselect.i.exp5.Forward.v2.",as.character(padj),".RData"))

#*#
load(paste0("dataY2andX/exp5/RES2.DLNMselect.i.exp5.Forward.v2.",as.character(padj),".RData"))

for(i in 1:nsim) {
  RES2.DLNMselect.i.exp5.v2_Forward[[i]]$DLNMpen.TP_dic <- ifelse(RES2.DLNMselect.i.exp5.v2_Forward[[i]]$p.value<0.05,1,0)
  #RES2.DLNMselect.i.exp5.v2_Forward[[i]]$DLNMpen.TP_dic[is.na(RES2.DLNMselect.i.exp5.v2_Forward[[i]]$p.value)] <- 0
}

save(RES2.DLNMselect.i.exp5.v2_Forward,file=paste0("dataY2andX/exp5/RES2.DLNMselect.i.exp5.Forward.v2.",as.character(padj),".RData"))
#*#

print("Step 7 - Completed model penalized DLNM with variable selection Forward prunning with additional columns (output: RES2.DLNMselect.i.exp5.Forward.v2...)")
